<template>
    <div class="box">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
            preserveAspectRatio="none" x="0px" y="0px" width="500px" height="800px" viewBox="0 0 500 800">
            <defs>
                <radialGradient id="Gradient_1" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="211.4" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, 0,0) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#9293D6" />

                    <stop offset="100%" stop-color="#9293D6" stop-opacity="0" />
                </radialGradient>

                <radialGradient id="Gradient_2" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="134.5" fx="0" fy="0"
                ...
                <radialGradient id="Gradient_3" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="66.10000000000002" fx="0"
                    fy="0" gradientTransform="matrix( 0.9999999999999998, 0, 0, 0.9999999999999998, 23.6,-99.85) "
                    spreadMethod="pad">
                ...
                <radialGradient id="Gradient_4" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="59.9" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, 17.85,-147.3) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#BBD5E8" />

                    <stop offset="100%" stop-color="#529FCE" />
                </radialGradient>

                <radialGradient id="Gradient_5" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="107.75" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, -21.9,21.95) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#A8D4F1" />

                    <stop offset="100%" stop-color="#57A0DE" />
                </radialGradient>

                <radialGradient id="Gradient_6" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="242.49999999999997" fx="0"
                    fy="0" gradientTransform="matrix( 1.0000000000000002, 0, 0, 1.0000000000000002, 36.4,-58.55) "
                    spreadMethod="pad">
                ...
                <linearGradient id="Gradient_7" gradientUnits="userSpaceOnUse" x1="-131.25" y1="-258.1" x2="131.25"
                    y2="-258.1" spreadMethod="pad">
                    <stop offset="0%" stop-color="#5599FF" />

                    <stop offset="100%" stop-color="#D5E6FF" />
                </linearGradient>

                <radialGradient id="Gradient_8" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="137.70000000000005" fx="0"
                    fy="0" gradientTransform="matrix( 0.9999999999999997, 0, 0, 0.9999999999999997, 76.45,-43.95) "
                    spreadMethod="pad">
                    <stop offset="0%" stop-color="#A8D4F1" />
                ...
                <radialGradient id="Gradient_9" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="77.75" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, 26.6,-22.8) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#FFF774" />

                    <stop offset="100%" stop-color="#FFCC00" />
                </radialGradient>

                <radialGradient id="Gradient_10" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="51.1" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, -19.85,10.05) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#FFF774" />

                    <stop offset="100%" stop-color="#FFCC00" />
                </radialGradient>

                <radialGradient id="Gradient_11" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="10.5" fx="0" fy="0"
                    gradientTransform="matrix( 1, 0, 0, 1, 0.15,-1.95) " spreadMethod="pad">
                    <stop offset="0%" stop-color="#FFF774" />
...
Q 12.8 -27.5 20.15 -20.15 28.55 -11.8 28.55 0 28.55 11.8 20.15 20.15 12.8 27.55 2.7 28.45 1.4 28.55 0 28.55 -11.8 28.55 -20.15 20.15 -21.2 19.1 -22.1 18.05 -26.55 12.7 -27.9 6.1 -28.5 3.15 -28.5 0 -28.5 -3.15 -27.9 -6.05 -26.55 -12.7 -22.1 -18 -21.2 -19.1 -20.15 -20.15 -11.8 -28.5 0 -28.5 1.4 -28.5 2.7 -28.35 Z" />
                    ...
                    <path fill="url(#Gradient_10)" stroke="none"
                        d="
M 20.15 -20.15
...
@keyframes confetti9 {
    0% {
        transform: matrix(0.258819580078125,
                -0.965911865234375,
                0.965911865234375,
                0.258819580078125,
                317.85,
    ...
    42.857142857142854% {
        transform: matrix(-0.999969482421875,
                0,
                0,
                -0.999969482421875,
                351.4,
    ...
    61.34453781512605% {
        transform: matrix(0.0000152587890625,
                0.9999237060546875,
                -0.9999237060546875,
                0.0000152587890625,
                394.55,
...
@keyframes confetti6 {
    0% {
        transform: matrix(0.70709228515625,
                -0.70709228515625,
                0.70709228515625,
                0.70709228515625,
                273.15,
    ...
    42.857142857142854% {
        transform: matrix(-0.96588134765625,
                -0.2587890625,
                0.2587890625,
                -0.96588134765625,
                273.25,
...
@keyframes confetti11 {
    0% {
        transform: matrix(-0.9659271240234375,
                0.2587890625,
                -0.2587890625,
                -0.9659271240234375,
                236,
    ...
    42.016806722689076% {
        transform: matrix(-0.4999847412109375,
                0.865966796875,
                -0.865966796875,
                -0.4999847412109375,
                278.8,
    ...
    58.82352941176471% {
        transform: matrix(-0.965850830078125,
                0.2587890625,
                -0.2587890625,
                -0.965850830078125,
                310.45,
...
@keyframes shadow {
    ...
    28.57142857142857% {
        transform: matrix(0.649444580078125, 0, 0, 0.649444580078125, 250, 742.25);
        opacity: 0.46875;
        animation-timing-function: ease-in;
    }
...
@keyframes handleL {
    ...
    28.57142857142857% {
        transform: matrix(0.76617431640625, 0, 0, 1, 158.85, 345.95);
        animation-timing-function: ease-in;
    }
...
@keyframes confetti7 {
    ...
    46.21848739495798% {
        transform: matrix(-0.8660125732421875,
                -0.5,
                0.5,
                -0.8660125732421875,
                380.55,
...
@keyframes star1 {
    0% {
        transform: matrix(0.6024169921875,
                0.79815673828125,
                -0.79815673828125,
                0.6024169921875,
                296,
    ...
    42.857142857142854% {
        transform: matrix(-0.712677001953125,
                0.701416015625,
                -0.701416015625,
                -0.712677001953125,
                292.5,
    ...
    64.70588235294117% {
        transform: matrix(-0.7884521484375,
                -0.61505126953125,
                0.61505126953125,
                -0.7884521484375,
                300.3,
...
@keyframes confetti3 {
    0% {
        transform: matrix(0.86602783203125,
                0.4999847412109375,
                -0.4999847412109375,
                0.86602783203125,
                192.1,
...
@keyframes confetti1 {
    ...
    67.22689075630252% {
        transform: matrix(0.965911865234375,
                0.2587890625,
                -0.2587890625,
                0.965911865234375,
                145.7,
...
@keyframes confetti8 {
    ...
    44.537815126050425% {
        transform: matrix(0, -0.999969482421875, 0.999969482421875, 0, 123.05, 130.6);
        opacity: 1;
        animation-timing-function: ease-in;
    }

    63.02521008403361% {
        transform: matrix(0.9658660888671875,
                0.2587738037109375,
                -0.2587738037109375,
                0.9658660888671875,
                96.7,
...
@keyframes star2 {
    ...
    44.537815126050425% {
        transform: matrix(-0.49993896484375,
                0.865936279296875,
                -0.865936279296875,
                -0.49993896484375,
                161.8,
...
@keyframes handleR {
    ...
    28.57142857142857% {
        transform: matrix(0.8685302734375, 0, 0, 1, 336.9, 347.5);
        animation-timing-function: ease-in;
    }
...
@keyframes star3 {
    0% {
        transform: matrix(0.7775726318359375,
                -0.6287841796875,
                0.6287841796875,
                0.7775726318359375,
                266.1,
    ...
    49.57983193277311% {
        transform: matrix(0.724853515625,
                0.6888275146484375,
                -0.6888275146484375,
                0.724853515625,
                361.8,
    ...
    67.22689075630252% {
        transform: matrix(-0.58831787109375,
                0.80859375,
                -0.80859375,
                -0.58831787109375,
                413.4,
...
@keyframes base {
    ...
    10.084033613445378% {
        transform: matrix(1, 0, 0, 0.82672119140625, 250, 747.2);
        animation-timing-function: ease-in;
    }
    ...
    18.487394957983195% {
        transform: matrix(1, 0, 0, 1.09295654296875, 250, 747.2);
        animation-timing-function: cubic-bezier(0.17, 0.76, 0.44, 0.97);
    }

    28.57142857142857% {
        transform: matrix(0.83404541015625, 0, 0, 1.09295654296875, 250, 678.7);
        animation-timing-function: ease-in;
    }
...
@keyframes confetti5 {
    ...
    44.537815126050425% {
        transform: matrix(0.7070770263671875,
                0.70709228515625,
                -0.70709228515625,
                0.7070770263671875,
                348.55,
...
#confetti9 {
    animation: confetti9 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti6 {
    animation: confetti6 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti11 {
    animation: confetti11 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti2 {
    animation: confetti2 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti7 {
    animation: confetti7 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#star1 {
    animation: star1 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti3 {
    animation: confetti3 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti1 {
    animation: confetti1 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti8 {
    animation: confetti8 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#star2 {
    animation: star2 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti10 {
    animation: confetti10 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#star3 {
    animation: star3 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti4 {
    animation: confetti4 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#confetti5 {
    animation: confetti5 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#shadow {
    animation: shadow 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#cup {
    animation: cup 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#handleL {
    animation: handleL 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#handleR {
    animation: handleR 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#medal {
    animation: medal 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#base {
    animation: base 1.9833333333333334s infinite;
    animation-delay: 0s;
}

#medalBack {
    animation: medalBack 1.9833333333333334s infinite;
    animation-delay: 0s;
}
