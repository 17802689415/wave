...
const imgData = ref<Img[]>([
    ...
    {id:2,path:'src/assets/photo1.jpg'},
    {id:3,path:'src/assets/photo2.jpg'},
    {id:4,path:'src/assets/photo3.jpg'},
    {id:5,path:'src/assets/photo4.jpg'},
    {id:6,path:'src/assets/photo5.jpg'},
    {id:7,path:'src/assets/photo6.jpg'},
])
